...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", type=str, required=(input_file_default is None), default=input_file_default, help="Path to input CSV file with sampling effort")
